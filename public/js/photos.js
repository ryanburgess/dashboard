...
var Flickr = _react2['default'].createClass({
  ...
  getInitialState: function getInitialState() {
    city = _configJson2['default'].settings.city;
    city = city.replace(' ', '+');
    api = _configJson2['default'].api.flickr;
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      ...
      photos.map(function (photo, i) {
        return _react2['default'].createElement(
          'li',
          { key: i, onClick: component.handleClick.bind(this, photo) },
...
_reactDom2['default'].render(_react2['default'].createElement(Flickr, null), target);

},{"../config.json":2,"react":159,"react-dom":3}],2:[function(require,module,exports){
module.exports={ 
  "settings": {
    "city": "San Francisco",
    "degree": "F"
