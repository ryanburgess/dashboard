...
},{"./index":7,"react":171,"react-dom":15}],2:[function(require,module,exports){
module.exports={ 
  "settings": {
    "city": "San Francisco",
    "degree": "F"
...
var App = _react2['default'].createClass({
  ...
  getInitialState: function getInitialState() {
    return { day: (0, _getDay2['default'])(), daily: _configJson2['default'].tasks, stock: _configJson2['default'].stock.symbol, city: _configJson2['default'].settings.city,
      degree: _configJson2['default'].settings.degree, weatherApi: _configJson2['default'].api.weather, flickrApi: _configJson2['default'].api.flickr };
  },
  componentDidMount: function componentDidMount() {
  ...
  render: function render() {
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'div',
        { className: 'content' },
        _react2['default'].createElement(_menu2['default'], { city: this.state.city, degrees: this.state.degree }),
        ...
        _react2['default'].createElement(_temp2['default'], { city: this.state.city, degree: this.state.degree, api: this.state.weatherApi,
...
},{"../config.json":2,"./clock":3,"./day":4,"./flickr":5,"./get-day":6,"./menu":8,"./mlb":9,"./month-day":10,"./stock":11,"./tasks":12,"./temp":13,"./time":14,"react":171}],8:[function(require,module,exports){
'use strict';
...
},{"../config.json":2,"react":171}],10:[function(require,module,exports){
'use strict';
